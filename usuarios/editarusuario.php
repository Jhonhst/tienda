  ...
  <body>
    ...
    <div class="col-12">
      <h2>Editar usuario</h2>
         <form method="POST" action="modificarusuario.php" onsubmit="return validar()">
            Agregar Nuevo Usuario:
            <input type="text" class="form-control" name="usuario" value="<?php echo $resultado_unico['usuario']; ?>">
            Agregar Nuevo Correo:
            <input type="text" id="correo" class="form-control mt-3" name="correo" value="<?php echo $resultado_unico['correo']; ?>">
            Agregar Nuevo Contrasenia:
            <input type="text" id="contrasenia" class="form-control mt-3" name="contrasenia" value="<?php echo $resultado_unico['contrasenia']; ?>">
            Agregar verifique contraseña:
            <input type="text" id="contraseniados" class="form-control mt-3" name="contraseniados" value="<?php echo $resultado_unico['cotraseniados']; ?>">
