...
$sql_leer= "SELECT * FROM productos WHERE nombre LIKE '%".$producto."%' ";
...
<html lang="en">
  <head>
    ...
    <title>Mi Tienda busqueda de producto</title>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ml-auto ">
          ...
          <li class="nav-item">
            ...
            <input type="submit" class="btn btn-primary mr-2" value="Cerrar Sección">
            </form>
          </li>
          <?php endif ?>
          <li class="nav-item">
